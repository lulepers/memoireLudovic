#ifndef SIMUINFOMODIFIER_HPP_
#define SIMUINFOMODIFIER_HPP_
...
class SimuInfoModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
...
public:
     ...
     * Destructor.
     */
    virtual ~SimuInfoModifier();



    static double nbrPart;
    static double nbrPartInscrite;
