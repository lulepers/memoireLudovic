#ifndef CELLPOLARITYYWRITER_HPP_
#define CELLPOLARITYYWRITER_HPP_
...
class CellPolarityYWriter : public AbstractCellWriter<ELEMENT_DIM, SPACE_DIM>
{
private:
...
#endif /* CellPolarityYWriter_HPP_ */
